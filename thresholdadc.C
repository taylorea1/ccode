...
void thresholdadc(int targetRow, int targetCol, double threshold)
{
...
leg->AddEntry(g,
              Form("Row %d Column %d",targetRow,targetCol),
              "p");
...
leg->Draw();
    ...
    c->SaveAs(Form("scatter_r%d_c%d.png",targetRow,targetCol));
}